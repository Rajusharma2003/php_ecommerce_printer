...
<body>
    ...
    <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="https://minion-vinovatheme.myshopify.com/cdn/shop/files/slideshow-1_f9506a0f-cd22-46e1-89e6-dfb216eda48b_1920x950.jpg?v=1617703696" class="d-block w-100" alt="Shop Now" style="height: 100vh; object-fit: cover;">
            ...
            <div class="carousel-item">
                <img src="https://minion-vinovatheme.myshopify.com/cdn/shop/files/img-12-4_1920x1920.jpg?v=1620271869" class="d-block w-100" alt="Special Offers" style="height: 100vh; object-fit: cover;">
                <div class="carousel-caption">
     ...
     <section class="py-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <img src="https://img.freepik.com/premium-photo/portrait-beautiful-young-girl-chooses-dress-cannot-be-determined_237326-864.jpg?ga=GA1.1.60748560.1748862681&semt=ais_items_boosted&w=740" alt="Our Store" class="img-fluid rounded shadow">
                </div>
                <div class="col-md-6">
    ...
    <section class="py-5 bg-dark text-white text-center" style="background-image: url('https://img.freepik.com/free-photo/beautiful-high-fashion-model-posing-studio_155003-8884.jpg?ga=GA1.1.1895318683.1717325595&semt=ais_ret_cs_clu'); background-size: cover; background-position: center; filter: brightness(0.7);">
    ...
    <section class="py-5 bg-white">
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="card border-0 shadow-sm h-100 product-spotlight-card">
                        <img src="https://minion-vinovatheme.myshopify.com/cdn/shop/files/img-12-3_570x700.jpg?v=1620271869" class="card-img-top" alt="Product 1">
                ...
                <div class="col-md-6">
                    <div class="row g-4 h-100">
                        <div class="col-md-12">
                            <div class="card border-0 shadow-sm h-100 product-spotlight-card">
                                <img src="https://minion-vinovatheme.myshopify.com/cdn/shop/files/slideshow-2_1920x950.jpg?v=1617703696" class="card-img-top" alt="Product 2">
                                <div class="card-img-overlay d-flex flex-column justify-content-end text-white p-4" style="background: linear-gradient(transparent, rgba(0,0,0,0.7));">
                        ...
                        <div class="col-md-12">
                            <div class="card border-0 shadow-sm h-100 product-spotlight-card">
                                <img src="https://minion-vinovatheme.myshopify.com/cdn/shop/files/slideshow-3_1920x950.jpg?v=1617703696" class="card-img-top" alt="Product 3">
                                <div class="card-img-overlay d-flex flex-column justify-content-end text-white p-4" style="background: linear-gradient(transparent, rgba(0,0,0,0.7));">
    ...
    <section class="py-5" style="background: linear-gradient(to right, #6a11cb, #2575fc); color: white;">
        <div class="container text-center">
            ...
            <p class="lead mb-5">Explore our extensive collection and discover products that fit your style and needs.</p>
                ...
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">"Amazing products and fast delivery! The quality is outstanding and the prices are very reasonable."</p>
                            <div class="mt-3">
                ...
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">"Great shopping experience! The customer service is excellent and the products are exactly as described."</p>
                            <div class="mt-3">
                ...
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text">"I love shopping here! The website is easy to use and the delivery is always on time."</p>
                            <div class="mt-3">
